...
const ROUNDS: Article[][] = [
  [
    { name: 'Botella de agua',    img: '/Articulos/Botella%20de%20Agua.png',    price: '0,80 €' },
    { name: 'Tableta de Chocolate', img: '/Articulos/Chocolate.png',            price: '2,50 €' },
    { name: 'Auriculares',        img: '/Articulos/Auriculares.png',            price: '25,00 €' },
    { name: 'Peluche',            img: '/Articulos/Peluche.png',                price: '15,00 €' },
  ],
  [
    { name: 'Brick de Leche',     img: '/Articulos/Leche.png',                  price: '1,10 €' },
    { name: 'Helado',             img: '/Articulos/Helado.png',                 price: '3,00 €' },
    { name: 'Muñeca',             img: '/Articulos/Mu%C3%B1eca.png',            price: '22,00 €' },
    { name: 'Patinete',           img: '/Articulos/Patinete.png',               price: '55,00 €' },
  ],
  [
    { name: 'Paquete de Arroz',   img: '/Articulos/Arroz.png',                  price: '1,20 €' },
    { name: 'Bolsa de patatas',   img: '/Articulos/Bolsa%20de%20Patatas.png',   price: '2,80 €' },
    { name: 'Mochila escolar',    img: '/Articulos/Mochila%20Escolar.png',      price: '28,00 €' },
    { name: 'Bicicleta',          img: '/Articulos/Bicicleta.png',              price: '90,00 €' },
  ],
  [
    { name: 'Paquete de Pasta',   img: '/Articulos/Pasta.png',                  price: '1,30 €' },
    { name: 'Videojuego',         img: '/Articulos/Videojuego.png',             price: '35,00 €' },
    { name: 'Mando de juego',     img: '/Articulos/MandoPlay.png',              price: '60,00 €' },
    { name: 'Tablet',             img: '/Articulos/Tablet.png',                 price: '180,00 €' },
  ],
  [
    { name: 'Chaqueta',           img: '/Articulos/Chaqueta.png',               price: '30,00 €' },
    { name: 'Coche teledirigido', img: '/Articulos/CocheTeledirigido.png',      price: '45,00 €' },
    { name: 'Nintendo Switch',    img: '/Articulos/Nintendo%20Switch.png',      price: '300,00 €' },
    { name: 'Viaje',              img: '/Articulos/Viaje.png',                  price: '650,00 €' },
  ],
]
